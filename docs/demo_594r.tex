...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={An investigation of mode choice in microsimulation.},
            colorlinks=false,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\begin{frontmatter}
  ...
  \title{An investigation of mode choice in microsimulation.}
  ...
  \end{abstract}
   \begin{keyword} Mode Choice Passive Data Location Choice\end{keyword}
 \end{frontmatter}
